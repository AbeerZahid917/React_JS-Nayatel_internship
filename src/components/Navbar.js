  ...
  return (
    <nav className={`navbar navbar-expand-lg`} style={getNavMode()}>
      <div className="container-fluid">
        <a className={`navbar-brand ${props.mode === 'light'? 'text-black': 'text-white'}`} href="/">{props.title}</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className={`nav-link ${props.mode === 'light'? 'text-black': 'text-white'}`} href="/">{props.aboutTexts}</a>
            </li>
          </ul>
